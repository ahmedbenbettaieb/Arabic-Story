...
export const storyParts: StoryPart[] = [
  {
    text: "بَنَتْ حَمَامَةٌ عُشَّهَا فِي جِذْعِ شَجَرَةٍ بِالْقُرْبِ مِنْ مَطْعَمِ صَغِيرٍ، فَكَانَ صَاحِبُ الْمَطْعَمِ يَنْثُرُ لَهَا وَلِفِرَاخِهَا فُتَاتَ الْخُبْزِ، لِتَتَغَذَّى بِهِ.",
